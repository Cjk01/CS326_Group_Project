const bios = ["Experience with full-stack web development, and that is also what I am interested in. Have experience with git, github, js, html/css, databases (mongo/mysql). I would be interested in focusing on the back-end of the web application for whichever project idea we decide to pursue.",
