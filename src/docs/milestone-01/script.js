const bios = ["Solid backend experience, limited front end experience. Technologies I’ve worked with include git, github, js, html/css, databases(mongo), and other commonly used languages(C/C++, Java, Python, etc.). I would prefer to work on the back end but would love to gain additional frontend experience. Overall, I’m excited to contribute whatever is necessary for the team to thrive.",
...
for(let i = 0 ; i < bios.length ;++i) {
    ...
    card.addEventListener("click", () => {
      ...
      bio.style.visibility = bio.style.visibility === "hidden" ? "visible" : "hidden";
    });
}
